            ...
            <table class="table-user text-center">
               ...
               <tbody>
                  ...
                  <tr>                              
                     ...
                     <td id="row_{{$item['id']}}" data-pagecode="{!! $item['pagecode'] !!}" data-title="{!! $item['title'] !!}" data-keyword="{!! $item['keyword'] !!}" data-meta-description="{{$item['meta_description']}}" data-priority="{!! $item['priority'] !!}" data-image="{!! $item['image'] !!}" data-isactive="{!! $item['isactive'] !!}" data-brief="{!!str_replace('"','&quot;', $item['brief'])!!}" data-content="{!! str_replace('"','&quot;', $item['content']) !!}">
