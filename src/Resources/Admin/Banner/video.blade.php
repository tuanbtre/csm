                  ...
                  <td style="width: 75%;vertical-align:top;">
                     <form id="MainForm" method="post" action="{{route('admin.banner.detail', [$cat->id])}}" name="MainForm" enctype="multipart/form-data">
                        ...
                        <table class="table-condensed table-responsive" style="width:100%">
                           ...
                           <tr>
		                        <td>
		                            <label for="image" class="control-label">File video (mp4)</label>
		                        </td>
		                        <td>
                     ...
                     <td style="width: 25%;vertical-align:top;">
                        <table class="table table-responsive table-condensed">
                           ...
                           @foreach ($list as $item)
                              <tr>
                                 <td class="cell_normal" style="cursor:pointer;" id="row_{!! $item['id'] !!}" onclick="active_item(this);SetRecord('{!! $item['id'] !!}')" data-title="{!! $item['title'] !!}" data-priority="{!! $item['priority'] !!}" data-image="{!! $item['image'] !!}" data-isactive="{!! $item['isactive'] !!}" data-youtube="{!!$item['youtube']!!}">{!! $item['title'] !!}
                              </tr>
                           @endforeach
                           <tr>
...
@section('javascript')
   ...
   function SetRecord(_id) {
      ...
      SetRecordTextBox('youtube', id_row, 'data-youtube', '');
