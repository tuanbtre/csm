                     ...
                     <td style="width: 25%;vertical-align:top;">
                        <table class="table table-responsive table-condensed">
                           ...
                           @foreach ($list as $item)
                              <tr>
                                 <td class="cell_normal" style="cursor:pointer;" id="row_{!! $item['id'] !!}" onclick="active_item(this);Set('{!! $item['id'] !!}')" data-title="{!! $item['title'] !!}" data-priority="{!! $item['priority'] !!}" data-image="{!! $item['image'] !!}" data-isactive="{!! $item['isactive'] !!}" data-youtube="{!!$item['youtube']!!}">{!! $item['title'] !!}
                              </tr>
                           @endforeach
                           <tr>
