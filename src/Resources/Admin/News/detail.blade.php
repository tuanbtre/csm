            ...
            <table class="table-user text-center">
               ...
               <tbody>
                  ...
                  <tr>                              
                     ...
                     <td id="row_{{$item['id']}}" data-title="{{$item['title']}}" data-isactive="{{$item['isactive']}}" data-image="{!! $item['image'] !!}" data-re_name="{{$item['re_name']}}" data-brief="{!! str_replace('"','&quot;', $item['brief']) !!}" data-content="{!! str_replace('"','&quot;', $item['content']) !!}" data-keyword="{{$item['keyword']}}" data-meta-description="{{$item['meta_description']}}" data-cat_id = "{!!$item['cat_id']!!}" data-priority="{{$item['priority']}}" data-isdefault="{{$item['isdefault']}}" data-updated_at="{!!$item->updated!!}" data-ishot="{{$item['ishot']}}" data-tag="{!!$item['tag']!!}">
