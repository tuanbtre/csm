...
<div class="page animsition" style="animation-duration: 800ms; opacity: 1;">
   <div class="col-md-12 col-xs-12">
      <div class="row">
         <div class="col-md-6">
            <h1 style="background:inherit">Giới thiệu</h1>   
         </div>
         <div class="col-md-6">
      ...
      <div class="col-xs-12 padding-0">
         ...
         <div class="col-md-4 col-sm-4 col-xs-12 padding-left-0">
            <div class="slinput">
               ...
               <a href="{!!route('admin.aboutus.index',['l'=>$current_language])!!}"><i class="fa fa-refresh right-icon-re"></i></a>
               <i class="fa fa-caret-down right-icon-select"></i> 
               <a href="javascript:void(0);" onclick="if(searchstr.value)location.href='{!!route('admin.aboutus.index',['l'=>$current_language])!!}&search='+searchstr.value;else searchstr.placeholder='Nhập nội dung cần tìm'" class="right-icon-a">Tìm kiếm</a>
            </div>
         </div>
            ...
            <table class="table-user text-center">
               ...
               <tbody>
                  ...
                  <tr>                              
                     ...
                     <td>{!!$item->title!!}</td>
                     <td>
                       <img style="cursor:pointer" onclick="ViewFile(this)" height="30" src="{{asset('images/about_us/'.$item->image)}}" alt="{{$item->title}}">
                     </td>
                     <td>{!!$item->priority!!}</td>
   ...
   <div class="modal-dialog">
      ...
      <div class="modal-body areaform">
         <section class="bg-white">
          <form name="MainForm" class="cd-form floating-labels" method="post" action="{!!route('admin.aboutus.index')!!}" enctype="multipart/form-data">
            @csrf
...
@section('javascript')
   ...
   function View(field) {
      ...
      if (filename == '') return;
      var path = '{{url('images/about_us')}}/' + filename;
   ...
   function DDLLanguageChange(_lang) {
      document.location.href = '{{url('admin/about-us')}}?l=' + _lang;
   }
