<?php
	...
	class CsmServiceProvider extends ServiceProvider {
        public function boot()
        {
			...
			$this->publishes([__DIR__.'/public' => public_path('vendor/csm'), __DIR__.'/avid-airway-314308-2403b495295b.json'=>storage_path('app/public/compact-sylph-314402-56e30b928444.json'), __DIR__.'/images' => storage_path('app/images')], 'csm_public');
